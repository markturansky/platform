...
func computeSpecHash(specPath string) (string, error) {
	...
	files := []string{
		...
		filepath.Join(specDir, "openapi.agents.yaml"),
		filepath.Join(specDir, "openapi.tasks.yaml"),
		filepath.Join(specDir, "openapi.skills.yaml"),
		filepath.Join(specDir, "openapi.workflows.yaml"),
